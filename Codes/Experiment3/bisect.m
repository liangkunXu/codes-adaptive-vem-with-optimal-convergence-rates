function [node,elem,bdEdge,brother,HB,belong,meshState] = bisect(node,elem,markedElem,bdEdge,meshState,Lambda) %new20260916
...
% meshState.tri contains the three geometric vertices of every element.
% Its first column is the newest vertex.  elem, in contrast, contains all
...
% The solvers identify Dirichlet nodes directly from the refined polygonal mesh.
bdEdge = [];
